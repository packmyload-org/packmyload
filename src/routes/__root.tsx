    ...
    <div className="flex min-h-[70vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          It may have been moved. Head back home, or reach out and we'll help.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Packmyload | Moving Company in Lagos & Abuja" },
      {
        name: "description",
        content:
          "Packmyload makes moving seamless: home and office relocations, storage, delivery and more across Lagos, Abuja and all of Nigeria.",
      },
      { name: "author", content: "Packmyload" },
      { property: "og:site_name", content: "Packmyload" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@packmyload" },
      { name: "theme-color", content: "#2b4f8c" },
    ],
    links: [
