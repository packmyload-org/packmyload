...
export const Route = createFileRoute("/international-relocations")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://pack-my-magic.lovable.app/international-relocations" },
      { property: "og:image", content: service.image },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: service.image },
    ],
    links: [{ rel: "canonical", href: "https://pack-my-magic.lovable.app/international-relocations" }],
  }),
